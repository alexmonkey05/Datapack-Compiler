execute unless score #var1_type 40planet_num matches 4 run tellraw @a {"text": "Operands must be of the same data type","color": "red"}
...
execute if score #operator_type 40planet_num matches 2..5 run tellraw @a {"text": "String only can operate \"add\"","color": "red"}
...
execute if score #operator_type 40planet_num matches 8..11 run tellraw @a {"text": "String only can operate \"add\"","color": "red"}
