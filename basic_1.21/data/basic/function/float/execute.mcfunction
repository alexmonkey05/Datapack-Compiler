...
execute unless score #var1_type 40planet_num matches 2 run tellraw @a {"text": "Operands must be of the same data type","color": "red"}
execute unless score #var1_type 40planet_num matches 2 run return fail
